...
void setup() {
  ...
  // configurando la escala de frecuencia del sensor a 20%
...
void loop() {
  ...
  // Definiendo la lectura de los fotodiodos sin filtro
  digitalWrite(S2,HIGH);
  digitalWrite(S3,LOW);
  
  // Leyendo la frecuencia de salida del sensor
  frecuenciaL = pulseIn(salidaSensor, LOW);
  
  // Mostrando por serie el valor para el azul (B = Blue)
  Serial.print(" L = ");
  Serial.print(frecuenciaL);
  delay(100);
